...
def main():
    ...
    # Dataset parameters
    parser.add_argument('--data_path', default='/disk1/neurips/dataset/train_pre_3class/', type=str,
                        help='training data path; subfolders: images, labels')
    parser.add_argument('--work_dir', default='/disk1/neurips/baselibe/work_dir',
    ...
    train_transforms = Compose(
        [
            LoadImaged(keys=["img", "label"], reader=PILReader, dtype=np.int16), # image three channels (H, W, 3); label: (H, W)
    ...
    val_transforms = Compose(
        [
            LoadImaged(keys=["img", "label"], reader=PILReader, dtype=np.int16),
        ...
        if epoch>20 and epoch % val_interval == 0:
            ...
            with torch.no_grad():
                ...
                if metric > best_metric:
                    ...
                    torch.save(checkpoint, join(model_path, "mybest_Loss_model.pth"))
                    print("saved new best metric model")
                    print(join(model_path, "mybest_Loss_model.pth"))
                print(
